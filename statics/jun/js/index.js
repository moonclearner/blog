var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('现在是|六月初五|君君酱生日|祝生日快乐|愿贪吃不胖|愿深情不负|愿傻人傻福|平安喜乐|得偿所愿|#rectangle|');
    }
...
S.Dot = function (x, y, r=255,g=255,b=255 ) {
  this.p = new S.Point({
    x: x,
    y: y,
    z: 5,
    ...
    switchShape: function (n, fast) {
      ...
      if (n.dots.length > dots.length) {
        ...
        for (var d = 1; d <= size; d++) {
          dots.push(new S.Dot(a.w / 2, a.h / 2, 255,255,255));
        }
      }
      var d = 0,
          i = 0;
